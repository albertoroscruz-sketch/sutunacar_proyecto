...
// 2. Transformamos la fecha a formato bonito
...
// 3. Forzamos la descarga del Word (Le ponemos "PREVIEW_" al nombre)
    ...
    <table style="width: 100%; border-collapse: collapse; border: none;">
        <tr>
            <td style="width: 20%; text-align: left; vertical-align: middle;">
                <img src="http://sutunacarprimeraprueba.infinityfreeapp.com/sutunacar.png" width="90" height="90">
            </td>
            ...
            <td style="width: 20%; text-align: right; vertical-align: middle;">
                <img src="http://sutunacarprimeraprueba.infinityfreeapp.com/escudo_unacar.png" width="90" height="90">
            </td>
        </tr>
    </table>
